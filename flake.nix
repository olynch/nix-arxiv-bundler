    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
        (with pkgs; let
          ...
          autoTeXConfig = writeText "Config.pm" ''
...
=cut
          ...
          autotex = buildPerlPackage rec {
            ...
            patchPhase = ''
              runHook prePatch
              ls
              cp ${autoTeXConfig} lib/TeX/AutoTeX/Config.pm
            '';
          ...
          '';
          preProcessedSource = stdenv.mkDerivation {
            name = "preprocessed-source.tar.gz";
          ...
          builtPaper = stdenv.mkDerivation {
            name = "built-paper";

            src = preProcessedSource;

            buildInputs = [ tex perl autotex ];
        ...
        in rec {
          packages.builtPaper = builtPaper;
          packages.preProcessedSource = preProcessedSource;
          packages.default = packages.builtPaper;
